...
## Overview
This app demonstrates use of the Bluetooth&#174; Audio Gateway (AG) profile.
...
- To create the audio gateway connection to a remote Hands-free controller, choose the Bluetooth&#174; address of the remote device from the BR/EDR combo box.
- Click "Connect" button under AG tab.<br/>
...
- NOTE : Default WBS is enabled, update hf\_control\_esco\_params structure to disable it.

## Button Functions
For 20721M2EVK & 55572BTEVK which support audio shield board, CUSTOM button is used to simulate Volume Control AT command.
Button event: click
1.  Custom: Increase/Decrease volume by sending AT cmd, it needs to validate by AT log traces in BTspy
2.  Vol+: N/A
3.  Vol-: N/A
